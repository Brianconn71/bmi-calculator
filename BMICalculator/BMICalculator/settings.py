...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'bmicalculator-frontend', 'build')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'bmicalculator-frontend', 'build', 'static')]
STATIC_ROOT = os.path.join(BASE_DIR, 'bmicalculator-frontend', 'build')
